# 110 — Search & Information Retrieval
...
## Definition
Search & Information Retrieval is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **Inverted Indexes:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Ranking:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Indexing:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Query Expansion:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Retrieval Pipelines:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **Inverted Indexes:** appears in planning, implementation, review, compliance, operations, or troubleshooting for search & information retrieval.
- **Ranking:** appears in planning, implementation, review, compliance, operations, or troubleshooting for search & information retrieval.
- **Indexing:** appears in planning, implementation, review, compliance, operations, or troubleshooting for search & information retrieval.
- **Query Expansion:** appears in planning, implementation, review, compliance, operations, or troubleshooting for search & information retrieval.
- **Retrieval Pipelines:** appears in planning, implementation, review, compliance, operations, or troubleshooting for search & information retrieval.
...
## Common Technologies
Typical technologies and standards include: Inverted Indexes, Ranking, Indexing, Query Expansion, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes search & information retrieval different from general application development?
