...
## Definition
Human-Computer Interaction is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **UX Research:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Information Architecture:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Interaction Design:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Cognitive Load:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Usability Testing:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **UX Research:** appears in planning, implementation, review, compliance, operations, or troubleshooting for human-computer interaction.
- **Information Architecture:** appears in planning, implementation, review, compliance, operations, or troubleshooting for human-computer interaction.
- **Interaction Design:** appears in planning, implementation, review, compliance, operations, or troubleshooting for human-computer interaction.
- **Cognitive Load:** appears in planning, implementation, review, compliance, operations, or troubleshooting for human-computer interaction.
- **Usability Testing:** appears in planning, implementation, review, compliance, operations, or troubleshooting for human-computer interaction.
...
## Common Technologies
Typical technologies and standards include: UX Research, Information Architecture, Interaction Design, Cognitive Load, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes human-computer interaction different from general application development?
