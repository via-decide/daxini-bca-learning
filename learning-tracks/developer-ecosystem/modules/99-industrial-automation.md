...
## Definition
Industrial Automation is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **PLC:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **SCADA:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **DCS:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **OPC-UA:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Industrial Networking:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **HMI:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **PLC:** appears in planning, implementation, review, compliance, operations, or troubleshooting for industrial automation.
- **SCADA:** appears in planning, implementation, review, compliance, operations, or troubleshooting for industrial automation.
- **DCS:** appears in planning, implementation, review, compliance, operations, or troubleshooting for industrial automation.
- **OPC-UA:** appears in planning, implementation, review, compliance, operations, or troubleshooting for industrial automation.
- **Industrial Networking:** appears in planning, implementation, review, compliance, operations, or troubleshooting for industrial automation.
...
## Common Technologies
Typical technologies and standards include: PLC, SCADA, DCS, OPC-UA, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes industrial automation different from general application development?
