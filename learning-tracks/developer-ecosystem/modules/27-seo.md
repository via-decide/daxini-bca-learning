...
## Covered Concepts
- **robots.txt** — see [Glossary](../glossary.md#robotstxt).
- **sitemap.xml** — see [Glossary](../glossary.md#sitemapxml).
- **Open Graph** — see [Glossary](../glossary.md#open-graph).
- **Canonical URLs** — see [Glossary](../glossary.md#canonical-urls).
- **Schema.org** — see [Glossary](../glossary.md#schemaorg).
- **Structured Data** — see [Glossary](../glossary.md#structured-data).

## 1. Definition
SEO is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
