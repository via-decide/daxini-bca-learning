...
## Covered Concepts
- **LLMs** — see [Glossary](../glossary.md#llms).
- **Embeddings** — see [Glossary](../glossary.md#embeddings).
- **RAG** — see [Glossary](../glossary.md#rag).
- **Prompt Engineering** — see [Glossary](../glossary.md#prompt-engineering).
- **Tool Calling** — see [Glossary](../glossary.md#tool-calling).
- **Structured Output** — see [Glossary](../glossary.md#structured-output).
- **Function Calling** — see [Glossary](../glossary.md#function-calling).
- **MCP** — see [Glossary](../glossary.md#mcp).
- **Context Windows** — see [Glossary](../glossary.md#context-windows).
- **Tokenization** — see [Glossary](../glossary.md#tokenization).
- **Agent Memory** — see [Glossary](../glossary.md#agent-memory).
- **Fine-Tuning** — see [Glossary](../glossary.md#fine-tuning).
- **LoRA** — see [Glossary](../glossary.md#lora).
- **Quantization** — see [Glossary](../glossary.md#quantization).
- **GGUF** — see [Glossary](../glossary.md#gguf).
- **Ollama** — see [Glossary](../glossary.md#ollama).
- **vLLM** — see [Glossary](../glossary.md#vllm).
- **OpenAI-Compatible APIs** — see [Glossary](../glossary.md#openai-compatible-apis).
- **Local Models** — see [Glossary](../glossary.md#local-models).

## 1. Definition
AI Engineering is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
