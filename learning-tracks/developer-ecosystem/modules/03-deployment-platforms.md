# 03 — Deployment Platforms

> Central glossary: [Engineering Glossary](../glossary.md)

## Covered Concepts
- **Vercel** — see [Glossary](../glossary.md#vercel).
- **Netlify** — see [Glossary](../glossary.md#netlify).
- **Cloudflare Pages** — see [Glossary](../glossary.md#cloudflare-pages).
- **Railway** — see [Glossary](../glossary.md#railway).
- **Render** — see [Glossary](../glossary.md#render).
- **Firebase Hosting** — see [Glossary](../glossary.md#firebase-hosting).
- **GitHub Pages** — see [Glossary](../glossary.md#github-pages).
- **Static Hosting** — see [Glossary](../glossary.md#static-hosting).
- **Dynamic Hosting** — see [Glossary](../glossary.md#dynamic-hosting).
- **Preview Deployments** — see [Glossary](../glossary.md#preview-deployments).
- **Production Deployments** — see [Glossary](../glossary.md#production-deployments).

## 1. Definition
Deployment Platforms is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
