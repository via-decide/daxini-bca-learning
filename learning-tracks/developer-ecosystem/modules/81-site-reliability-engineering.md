# 81 — Site Reliability Engineering (SRE)
...
## Definition
Site Reliability Engineering (SRE) is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **SLO:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **SLA:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **SLI:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Error Budgets:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Incident Management:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Runbooks:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Reliability Engineering:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **On-call:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Blameless Postmortems:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **SLO:** appears in planning, implementation, review, compliance, operations, or troubleshooting for site reliability engineering (sre).
- **SLA:** appears in planning, implementation, review, compliance, operations, or troubleshooting for site reliability engineering (sre).
- **SLI:** appears in planning, implementation, review, compliance, operations, or troubleshooting for site reliability engineering (sre).
- **Error Budgets:** appears in planning, implementation, review, compliance, operations, or troubleshooting for site reliability engineering (sre).
- **Incident Management:** appears in planning, implementation, review, compliance, operations, or troubleshooting for site reliability engineering (sre).
...
## Common Technologies
Typical technologies and standards include: SLO, SLA, SLI, Error Budgets, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.

## Workflow Diagrams
```mermaid
flowchart LR
  Users[Users] --> SLI[Measure SLI]
  SLI --> SLO[Compare with SLO]
  SLO --> Budget[Track error budget]
  Budget --> Alert[Alert or slow releases]
  Alert --> Incident[Incident response]
  Incident --> Postmortem[Blameless postmortem]
  Postmortem --> Runbook[Improve runbooks]
```
...
## Interview Questions
1. What makes site reliability engineering (sre) different from general application development?
