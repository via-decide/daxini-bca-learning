...
## Covered Concepts
- **Vite** — see [Glossary](../glossary.md#vite).
- **Webpack** — see [Glossary](../glossary.md#webpack).
- **Rollup** — see [Glossary](../glossary.md#rollup).
- **esbuild** — see [Glossary](../glossary.md#esbuild).
- **SWC** — see [Glossary](../glossary.md#swc).
- **Babel** — see [Glossary](../glossary.md#babel).
- **Turbopack** — see [Glossary](../glossary.md#turbopack).

## 1. Definition
Build Tools is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
