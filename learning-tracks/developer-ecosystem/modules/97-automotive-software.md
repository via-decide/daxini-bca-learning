...
## Definition
Automotive Software is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **AUTOSAR:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **CAN Bus:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **LIN:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **ECU:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Functional Safety:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **ISO 26262:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **AUTOSAR:** appears in planning, implementation, review, compliance, operations, or troubleshooting for automotive software.
- **CAN Bus:** appears in planning, implementation, review, compliance, operations, or troubleshooting for automotive software.
- **LIN:** appears in planning, implementation, review, compliance, operations, or troubleshooting for automotive software.
- **ECU:** appears in planning, implementation, review, compliance, operations, or troubleshooting for automotive software.
- **Functional Safety:** appears in planning, implementation, review, compliance, operations, or troubleshooting for automotive software.
...
## Common Technologies
Typical technologies and standards include: AUTOSAR, CAN Bus, LIN, ECU, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes automotive software different from general application development?
