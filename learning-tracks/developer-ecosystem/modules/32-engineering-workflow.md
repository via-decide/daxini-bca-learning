...
## Covered Concepts
- **Planning** — see [Glossary](../glossary.md#planning).
- **Issues** — see [Glossary](../glossary.md#issues).
- **Kanban** — see [Glossary](../glossary.md#kanban).
- **Scrum** — see [Glossary](../glossary.md#scrum).
- **Roadmaps** — see [Glossary](../glossary.md#roadmaps).
- **Sprints** — see [Glossary](../glossary.md#sprints).
- **Releases** — see [Glossary](../glossary.md#releases).
- **Code Reviews** — see [Glossary](../glossary.md#code-reviews).
- **Documentation** — see [Glossary](../glossary.md#documentation).
- **Technical Debt** — see [Glossary](../glossary.md#technical-debt).

## 1. Definition
Engineering Workflow is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
