...
## Definition
Engineering Communication is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **RFCs:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **ADRs:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Design Documents:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Technical Writing:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Documentation Standards:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Architecture Reviews:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **RFCs:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering communication.
- **ADRs:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering communication.
- **Design Documents:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering communication.
- **Technical Writing:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering communication.
- **Documentation Standards:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering communication.
...
## Common Technologies
Typical technologies and standards include: RFCs, ADRs, Design Documents, Technical Writing, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes engineering communication different from general application development?
