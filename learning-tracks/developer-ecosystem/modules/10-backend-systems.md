...
## Covered Concepts
- **Servers** — see [Glossary](../glossary.md#servers).
- **Serverless** — see [Glossary](../glossary.md#serverless).
- **Edge Functions** — see [Glossary](../glossary.md#edge-functions).
- **Workers** — see [Glossary](../glossary.md#workers).
- **Cron Jobs** — see [Glossary](../glossary.md#cron-jobs).
- **Queues** — see [Glossary](../glossary.md#queues).
- **Message Brokers** — see [Glossary](../glossary.md#message-brokers).
- **Background Processing** — see [Glossary](../glossary.md#background-processing).

## 1. Definition
Backend Systems is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
