...
## Covered Concepts
- **Continuous Integration** — see [Glossary](../glossary.md#continuous-integration).
- **Continuous Delivery** — see [Glossary](../glossary.md#continuous-delivery).
- **Continuous Deployment** — see [Glossary](../glossary.md#continuous-deployment).
- **GitHub Actions** — see [Glossary](../glossary.md#github-actions).
- **Build Pipelines** — see [Glossary](../glossary.md#build-pipelines).
- **Automated Testing** — see [Glossary](../glossary.md#automated-testing).
- **Deployment Pipelines** — see [Glossary](../glossary.md#deployment-pipelines).

## 1. Definition
CI/CD is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
