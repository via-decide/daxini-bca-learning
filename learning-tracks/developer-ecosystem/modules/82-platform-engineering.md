...
## Definition
Platform Engineering is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **Internal Developer Platforms:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Self-Service Infrastructure:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Golden Paths:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Service Catalogs:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Platform APIs:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **Internal Developer Platforms:** appears in planning, implementation, review, compliance, operations, or troubleshooting for platform engineering.
- **Self-Service Infrastructure:** appears in planning, implementation, review, compliance, operations, or troubleshooting for platform engineering.
- **Golden Paths:** appears in planning, implementation, review, compliance, operations, or troubleshooting for platform engineering.
- **Service Catalogs:** appears in planning, implementation, review, compliance, operations, or troubleshooting for platform engineering.
- **Platform APIs:** appears in planning, implementation, review, compliance, operations, or troubleshooting for platform engineering.
...
## Common Technologies
Typical technologies and standards include: Internal Developer Platforms, Self-Service Infrastructure, Golden Paths, Service Catalogs, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes platform engineering different from general application development?
