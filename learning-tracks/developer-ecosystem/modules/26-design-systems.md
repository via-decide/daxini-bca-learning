...
## Covered Concepts
- **Figma** — see [Glossary](../glossary.md#figma).
- **Design Systems** — see [Glossary](../glossary.md#design-systems).
- **Design Tokens** — see [Glossary](../glossary.md#design-tokens).
- **Atomic Design** — see [Glossary](../glossary.md#atomic-design).
- **Accessibility** — see [Glossary](../glossary.md#accessibility).
- **WCAG** — see [Glossary](../glossary.md#wcag).

## 1. Definition
Design Systems is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
