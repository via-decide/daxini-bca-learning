...
## Definition
Startup Engineering is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **Rapid Prototyping:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Technical Validation:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Product-Market Fit:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Scaling Teams:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Engineering Culture:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **Rapid Prototyping:** appears in planning, implementation, review, compliance, operations, or troubleshooting for startup engineering.
- **Technical Validation:** appears in planning, implementation, review, compliance, operations, or troubleshooting for startup engineering.
- **Product-Market Fit:** appears in planning, implementation, review, compliance, operations, or troubleshooting for startup engineering.
- **Scaling Teams:** appears in planning, implementation, review, compliance, operations, or troubleshooting for startup engineering.
- **Engineering Culture:** appears in planning, implementation, review, compliance, operations, or troubleshooting for startup engineering.
...
## Common Technologies
Typical technologies and standards include: Rapid Prototyping, Technical Validation, Product-Market Fit, Scaling Teams, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes startup engineering different from general application development?
