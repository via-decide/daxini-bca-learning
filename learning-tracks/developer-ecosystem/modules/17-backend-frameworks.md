...
## Covered Concepts
- **Express** — see [Glossary](../glossary.md#express).
- **Fastify** — see [Glossary](../glossary.md#fastify).
- **NestJS** — see [Glossary](../glossary.md#nestjs).
- **Django** — see [Glossary](../glossary.md#django).
- **Laravel** — see [Glossary](../glossary.md#laravel).
- **Spring Boot** — see [Glossary](../glossary.md#spring-boot).
- **ASP.NET** — see [Glossary](../glossary.md#aspnet).

## 1. Definition
Backend Frameworks is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
