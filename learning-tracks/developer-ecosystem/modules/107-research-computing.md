...
## Definition
Research Computing is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **Academic Computing:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **HPC Clusters:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Reproducible Research:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Scientific Workflows:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **Academic Computing:** appears in planning, implementation, review, compliance, operations, or troubleshooting for research computing.
- **HPC Clusters:** appears in planning, implementation, review, compliance, operations, or troubleshooting for research computing.
- **Reproducible Research:** appears in planning, implementation, review, compliance, operations, or troubleshooting for research computing.
- **Scientific Workflows:** appears in planning, implementation, review, compliance, operations, or troubleshooting for research computing.
...
## Common Technologies
Typical technologies and standards include: Academic Computing, HPC Clusters, Reproducible Research, Scientific Workflows, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes research computing different from general application development?
