...
## Covered Concepts
- **Unit Testing** — see [Glossary](../glossary.md#unit-testing).
- **Integration Testing** — see [Glossary](../glossary.md#integration-testing).
- **End-to-End Testing** — see [Glossary](../glossary.md#end-to-end-testing).
- **Jest** — see [Glossary](../glossary.md#jest).
- **Vitest** — see [Glossary](../glossary.md#vitest).
- **Playwright** — see [Glossary](../glossary.md#playwright).
- **Cypress** — see [Glossary](../glossary.md#cypress).

## 1. Definition
Testing is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
