...
## Covered Concepts
- **Elasticsearch** — see [Glossary](../glossary.md#elasticsearch).
- **Meilisearch** — see [Glossary](../glossary.md#meilisearch).
- **Algolia** — see [Glossary](../glossary.md#algolia).
- **Typesense** — see [Glossary](../glossary.md#typesense).
- **Full-text Search** — see [Glossary](../glossary.md#full-text-search).
- **Hybrid Search** — see [Glossary](../glossary.md#hybrid-search).
- **Semantic Search** — see [Glossary](../glossary.md#semantic-search).

## 1. Definition
Search Systems is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
