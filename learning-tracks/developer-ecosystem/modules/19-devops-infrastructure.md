...
## Covered Concepts
- **Kubernetes** — see [Glossary](../glossary.md#kubernetes).
- **Helm** — see [Glossary](../glossary.md#helm).
- **Terraform** — see [Glossary](../glossary.md#terraform).
- **Pulumi** — see [Glossary](../glossary.md#pulumi).
- **Ansible** — see [Glossary](../glossary.md#ansible).
- **Infrastructure as Code** — see [Glossary](../glossary.md#infrastructure-as-code).
- **Secrets Management** — see [Glossary](../glossary.md#secrets-management).
- **Vault** — see [Glossary](../glossary.md#vault).

## 1. Definition
DevOps & Infrastructure is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
