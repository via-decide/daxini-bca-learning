...
## Definition
Engineering Ethics is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **Responsible AI:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Privacy:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Bias:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Accessibility:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Sustainability:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Professional Ethics:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **Responsible AI:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering ethics.
- **Privacy:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering ethics.
- **Bias:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering ethics.
- **Accessibility:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering ethics.
- **Sustainability:** appears in planning, implementation, review, compliance, operations, or troubleshooting for engineering ethics.
...
## Common Technologies
Typical technologies and standards include: Responsible AI, Privacy, Bias, Accessibility, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes engineering ethics different from general application development?
