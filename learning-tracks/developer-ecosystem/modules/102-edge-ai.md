...
## Definition
Edge AI is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **TinyML:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **On-device Inference:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **AI Accelerators:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Edge Deployment:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Sensor Fusion:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **TinyML:** appears in planning, implementation, review, compliance, operations, or troubleshooting for edge ai.
- **On-device Inference:** appears in planning, implementation, review, compliance, operations, or troubleshooting for edge ai.
- **AI Accelerators:** appears in planning, implementation, review, compliance, operations, or troubleshooting for edge ai.
- **Edge Deployment:** appears in planning, implementation, review, compliance, operations, or troubleshooting for edge ai.
- **Sensor Fusion:** appears in planning, implementation, review, compliance, operations, or troubleshooting for edge ai.
...
## Common Technologies
Typical technologies and standards include: TinyML, On-device Inference, AI Accelerators, Edge Deployment, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes edge ai different from general application development?
