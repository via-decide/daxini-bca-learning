...
## Covered Concepts
- **PostgreSQL** — see [Glossary](../glossary.md#postgresql).
- **MySQL** — see [Glossary](../glossary.md#mysql).
- **SQLite** — see [Glossary](../glossary.md#sqlite).
- **MongoDB** — see [Glossary](../glossary.md#mongodb).
- **Redis** — see [Glossary](../glossary.md#redis).
- **S3** — see [Glossary](../glossary.md#s3).
- **Blob Storage** — see [Glossary](../glossary.md#blob-storage).
- **Cloudflare R2** — see [Glossary](../glossary.md#cloudflare-r2).
- **File Systems** — see [Glossary](../glossary.md#file-systems).
- **NAS** — see [Glossary](../glossary.md#nas).
- **Vector Databases** — see [Glossary](../glossary.md#vector-databases).

## 1. Definition
Databases & Storage is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
