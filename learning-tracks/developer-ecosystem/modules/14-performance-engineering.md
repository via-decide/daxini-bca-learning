...
## Covered Concepts
- **Core Web Vitals** — see [Glossary](../glossary.md#core-web-vitals).
- **Lighthouse** — see [Glossary](../glossary.md#lighthouse).
- **LCP** — see [Glossary](../glossary.md#lcp).
- **CLS** — see [Glossary](../glossary.md#cls).
- **INP** — see [Glossary](../glossary.md#inp).
- **FCP** — see [Glossary](../glossary.md#fcp).
- **TTFB** — see [Glossary](../glossary.md#ttfb).
- **Bundle Analysis** — see [Glossary](../glossary.md#bundle-analysis).
- **WebPageTest** — see [Glossary](../glossary.md#webpagetest).

## 1. Definition
Performance Engineering is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
