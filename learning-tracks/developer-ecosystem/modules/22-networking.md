...
## Covered Concepts
- **TCP/IP** — see [Glossary](../glossary.md#tcpip).
- **UDP** — see [Glossary](../glossary.md#udp).
- **HTTP/1.1** — see [Glossary](../glossary.md#http11).
- **HTTP/2** — see [Glossary](../glossary.md#http2).
- **HTTP/3** — see [Glossary](../glossary.md#http3).
- **QUIC** — see [Glossary](../glossary.md#quic).
- **DNS** — see [Glossary](../glossary.md#dns).
- **DNS over HTTPS** — see [Glossary](../glossary.md#dns-over-https).
- **TLS Handshake** — see [Glossary](../glossary.md#tls-handshake).

## 1. Definition
Networking is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
