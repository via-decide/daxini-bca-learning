...
## Covered Concepts
- **OAuth** — see [Glossary](../glossary.md#oauth).
- **OpenID Connect** — see [Glossary](../glossary.md#openid-connect).
- **JWT** — see [Glossary](../glossary.md#jwt).
- **Sessions** — see [Glossary](../glossary.md#sessions).
- **Cookies** — see [Glossary](../glossary.md#cookies).
- **API Keys** — see [Glossary](../glossary.md#api-keys).
- **Passkeys** — see [Glossary](../glossary.md#passkeys).
- **MFA** — see [Glossary](../glossary.md#mfa).
- **RBAC** — see [Glossary](../glossary.md#rbac).
- **IAM** — see [Glossary](../glossary.md#iam).

## 1. Definition
Authentication & Identity is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
