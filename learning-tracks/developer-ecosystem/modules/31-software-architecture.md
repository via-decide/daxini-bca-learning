...
## Covered Concepts
- **MVC** — see [Glossary](../glossary.md#mvc).
- **Layered Architecture** — see [Glossary](../glossary.md#layered-architecture).
- **Clean Architecture** — see [Glossary](../glossary.md#clean-architecture).
- **Hexagonal Architecture** — see [Glossary](../glossary.md#hexagonal-architecture).
- **Repository Pattern** — see [Glossary](../glossary.md#repository-pattern).
- **Event-Driven Architecture** — see [Glossary](../glossary.md#event-driven-architecture).
- **Monolith** — see [Glossary](../glossary.md#monolith).
- **Modular Monolith** — see [Glossary](../glossary.md#modular-monolith).
- **Microservices** — see [Glossary](../glossary.md#microservices).

## 1. Definition
Software Architecture is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
