...
## Covered Concepts
- **AWS** — see [Glossary](../glossary.md#aws).
- **Azure** — see [Glossary](../glossary.md#azure).
- **Google Cloud** — see [Glossary](../glossary.md#google-cloud).
- **Regions** — see [Glossary](../glossary.md#regions).
- **Availability Zones** — see [Glossary](../glossary.md#availability-zones).
- **Compute** — see [Glossary](../glossary.md#compute).
- **Networking** — see [Glossary](../glossary.md#networking).
- **Virtual Machines** — see [Glossary](../glossary.md#virtual-machines).
- **Object Storage** — see [Glossary](../glossary.md#object-storage).
- **Identity Management** — see [Glossary](../glossary.md#identity-management).

## 1. Definition
Cloud Computing is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
