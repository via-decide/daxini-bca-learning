...
## Definition
API Management is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **API Gateways:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Service Mesh:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Kong:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Envoy:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Istio:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Rate Policies:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **API Gateways:** appears in planning, implementation, review, compliance, operations, or troubleshooting for api management.
- **Service Mesh:** appears in planning, implementation, review, compliance, operations, or troubleshooting for api management.
- **Kong:** appears in planning, implementation, review, compliance, operations, or troubleshooting for api management.
- **Envoy:** appears in planning, implementation, review, compliance, operations, or troubleshooting for api management.
- **Istio:** appears in planning, implementation, review, compliance, operations, or troubleshooting for api management.
...
## Common Technologies
Typical technologies and standards include: API Gateways, Service Mesh, Kong, Envoy, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes api management different from general application development?
