...
## Covered Concepts
- **Logs** — see [Glossary](../glossary.md#logs).
- **Metrics** — see [Glossary](../glossary.md#metrics).
- **Tracing** — see [Glossary](../glossary.md#tracing).
- **Prometheus** — see [Glossary](../glossary.md#prometheus).
- **Grafana** — see [Glossary](../glossary.md#grafana).
- **Loki** — see [Glossary](../glossary.md#loki).
- **Jaeger** — see [Glossary](../glossary.md#jaeger).
- **OpenTelemetry** — see [Glossary](../glossary.md#opentelemetry).
- **Sentry** — see [Glossary](../glossary.md#sentry).
- **Uptime Monitoring** — see [Glossary](../glossary.md#uptime-monitoring).

## 1. Definition
Monitoring & Observability is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
