...
## Covered Concepts
- **Git** — see [Glossary](../glossary.md#git).
- **GitHub** — see [Glossary](../glossary.md#github).
- **GitLab** — see [Glossary](../glossary.md#gitlab).
- **Bitbucket** — see [Glossary](../glossary.md#bitbucket).
- **Repositories** — see [Glossary](../glossary.md#repositories).
- **Branches** — see [Glossary](../glossary.md#branches).
- **Commits** — see [Glossary](../glossary.md#commits).
- **Pull Requests** — see [Glossary](../glossary.md#pull-requests).
- **Merge Conflicts** — see [Glossary](../glossary.md#merge-conflicts).
- **Rebasing** — see [Glossary](../glossary.md#rebasing).
- **Cherry Picking** — see [Glossary](../glossary.md#cherry-picking).
- **Forks** — see [Glossary](../glossary.md#forks).
- **Release Tags** — see [Glossary](../glossary.md#release-tags).
- **Git Flow** — see [Glossary](../glossary.md#git-flow).
- **Trunk Based Development** — see [Glossary](../glossary.md#trunk-based-development).
- **Conventional Commits** — see [Glossary](../glossary.md#conventional-commits).
- **Monorepo** — see [Glossary](../glossary.md#monorepo).
- **Polyrepo** — see [Glossary](../glossary.md#polyrepo).
- **Git LFS** — see [Glossary](../glossary.md#git-lfs).
- **CODEOWNERS** — see [Glossary](../glossary.md#codeowners).
- **Semantic Release** — see [Glossary](../glossary.md#semantic-release).

## 1. Definition
Version Control & Collaboration is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
