...
## Covered Concepts
- **Stripe** — see [Glossary](../glossary.md#stripe).
- **Razorpay** — see [Glossary](../glossary.md#razorpay).
- **Webhooks** — see [Glossary](../glossary.md#webhooks).
- **Idempotency** — see [Glossary](../glossary.md#idempotency).
- **PCI DSS** — see [Glossary](../glossary.md#pci-dss).

## 1. Definition
Payments is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
