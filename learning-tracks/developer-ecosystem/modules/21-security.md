...
## Covered Concepts
- **OWASP** — see [Glossary](../glossary.md#owasp).
- **XSS** — see [Glossary](../glossary.md#xss).
- **CSRF** — see [Glossary](../glossary.md#csrf).
- **SQL Injection** — see [Glossary](../glossary.md#sql-injection).
- **CSP** — see [Glossary](../glossary.md#csp).
- **CORS** — see [Glossary](../glossary.md#cors).
- **HSTS** — see [Glossary](../glossary.md#hsts).
- **SameSite Cookies** — see [Glossary](../glossary.md#samesite-cookies).
- **Zero Trust** — see [Glossary](../glossary.md#zero-trust).
- **WAF** — see [Glossary](../glossary.md#waf).
- **Encryption** — see [Glossary](../glossary.md#encryption).
- **Hashing** — see [Glossary](../glossary.md#hashing).
- **Secrets** — see [Glossary](../glossary.md#secrets).
- **Environment Variables** — see [Glossary](../glossary.md#environment-variables).

## 1. Definition
Security is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
