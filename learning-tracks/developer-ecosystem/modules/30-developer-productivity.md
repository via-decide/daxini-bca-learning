...
## Covered Concepts
- **VS Code** — see [Glossary](../glossary.md#vs-code).
- **Cursor** — see [Glossary](../glossary.md#cursor).
- **Windsurf** — see [Glossary](../glossary.md#windsurf).
- **Claude Code** — see [Glossary](../glossary.md#claude-code).
- **Codex** — see [Glossary](../glossary.md#codex).
- **Gemini CLI** — see [Glossary](../glossary.md#gemini-cli).
- **Bash** — see [Glossary](../glossary.md#bash).
- **Zsh** — see [Glossary](../glossary.md#zsh).
- **Fish** — see [Glossary](../glossary.md#fish).
- **SSH** — see [Glossary](../glossary.md#ssh).
- **tmux** — see [Glossary](../glossary.md#tmux).
- **Makefile** — see [Glossary](../glossary.md#makefile).
- **Taskfile** — see [Glossary](../glossary.md#taskfile).
- **Homebrew** — see [Glossary](../glossary.md#homebrew).
- **Chocolatey** — see [Glossary](../glossary.md#chocolatey).

## 1. Definition
Developer Productivity is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
