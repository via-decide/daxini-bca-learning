# 94 — Electronic Design Automation (EDA)
...
## Definition
Electronic Design Automation (EDA) is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **PCB Design:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Schematic Capture:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **HDL:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Verilog:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **VHDL:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **FPGA Toolchains:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **PCB Design:** appears in planning, implementation, review, compliance, operations, or troubleshooting for electronic design automation (eda).
- **Schematic Capture:** appears in planning, implementation, review, compliance, operations, or troubleshooting for electronic design automation (eda).
- **HDL:** appears in planning, implementation, review, compliance, operations, or troubleshooting for electronic design automation (eda).
- **Verilog:** appears in planning, implementation, review, compliance, operations, or troubleshooting for electronic design automation (eda).
- **VHDL:** appears in planning, implementation, review, compliance, operations, or troubleshooting for electronic design automation (eda).
...
## Common Technologies
Typical technologies and standards include: PCB Design, Schematic Capture, HDL, Verilog, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.
...
## Interview Questions
1. What makes electronic design automation (eda) different from general application development?
