...
## Covered Concepts
- **Markdown** — see [Glossary](../glossary.md#markdown).
- **Mermaid** — see [Glossary](../glossary.md#mermaid).
- **OpenAPI** — see [Glossary](../glossary.md#openapi).
- **Swagger** — see [Glossary](../glossary.md#swagger).
- **AsyncAPI** — see [Glossary](../glossary.md#asyncapi).
- **Docusaurus** — see [Glossary](../glossary.md#docusaurus).

## 1. Definition
Documentation is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
