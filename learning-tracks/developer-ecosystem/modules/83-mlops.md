...
## Definition
MLOps is a specialized engineering domain where software connects with reliability, business operations, scientific workflows, hardware, infrastructure, human factors, regulation, or emerging technology.
...
## Core Concepts
- **Model Deployment:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Model Registry:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Experiment Tracking:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Drift Detection:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Feature Stores:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.
- **Online vs Offline Inference:** learn what it means, why specialists use it, what data or systems it affects, and what can go wrong when it is misunderstood.

## Industry Applications
- **Model Deployment:** appears in planning, implementation, review, compliance, operations, or troubleshooting for mlops.
- **Model Registry:** appears in planning, implementation, review, compliance, operations, or troubleshooting for mlops.
- **Experiment Tracking:** appears in planning, implementation, review, compliance, operations, or troubleshooting for mlops.
- **Drift Detection:** appears in planning, implementation, review, compliance, operations, or troubleshooting for mlops.
- **Feature Stores:** appears in planning, implementation, review, compliance, operations, or troubleshooting for mlops.
...
## Common Technologies
Typical technologies and standards include: Model Deployment, Model Registry, Experiment Tracking, Drift Detection, domain-specific standards, open-source tooling, vendor platforms. Product names change over time, so focus on the role each technology plays in the architecture.

## Workflow Diagrams
```mermaid
flowchart LR
  Data[Training data] --> Experiment[Experiment tracking]
  Experiment --> Registry[Model registry]
  Registry --> Deploy[Model deployment]
  Deploy --> Inference[Online/offline inference]
  Inference --> Monitor[Drift detection]
...
## Interview Questions
1. What makes mlops different from general application development?
