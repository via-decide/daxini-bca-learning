# 23 — Messaging Systems

> Central glossary: [Engineering Glossary](../glossary.md)

## Covered Concepts
- **Kafka** — see [Glossary](../glossary.md#kafka).
- **RabbitMQ** — see [Glossary](../glossary.md#rabbitmq).
- **NATS** — see [Glossary](../glossary.md#nats).
- **MQTT** — see [Glossary](../glossary.md#mqtt).
- **Redis Streams** — see [Glossary](../glossary.md#redis-streams).

## 1. Definition
Messaging Systems is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
