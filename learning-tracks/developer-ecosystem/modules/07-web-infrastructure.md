# 07 — Web Infrastructure

> Central glossary: [Engineering Glossary](../glossary.md)

## Covered Concepts
- **DNS** — see [Glossary](../glossary.md#dns).
- **CDN** — see [Glossary](../glossary.md#cdn).
- **HTTPS** — see [Glossary](../glossary.md#https).
- **SSL/TLS** — see [Glossary](../glossary.md#ssltls).
- **Reverse Proxy** — see [Glossary](../glossary.md#reverse-proxy).
- **Edge Network** — see [Glossary](../glossary.md#edge-network).
- **Caching** — see [Glossary](../glossary.md#caching).
- **Cache-Control** — see [Glossary](../glossary.md#cache-control).
- **ETag** — see [Glossary](../glossary.md#etag).
- **Cloudflare** — see [Glossary](../glossary.md#cloudflare).

## 1. Definition
Web Infrastructure is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
