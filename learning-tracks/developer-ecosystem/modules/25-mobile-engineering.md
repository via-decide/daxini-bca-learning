...
## Covered Concepts
- **Flutter** — see [Glossary](../glossary.md#flutter).
- **React Native** — see [Glossary](../glossary.md#react-native).
- **Capacitor** — see [Glossary](../glossary.md#capacitor).
- **Expo** — see [Glossary](../glossary.md#expo).
- **App Signing** — see [Glossary](../glossary.md#app-signing).

## 1. Definition
Mobile Engineering is the industry practice area that turns academic computing knowledge into repeatable team workflows, production systems, and maintainable software.
