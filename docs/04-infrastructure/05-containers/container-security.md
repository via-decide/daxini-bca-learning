...
## Purpose
This page implements the `Container Security` chapter for Module 5: Containers.

## Concepts
- **Image scanning**: Define, recognize, and apply this concept in realistic engineering work.
- **Registry security**: Define, recognize, and apply this concept in realistic engineering work.
- **Runtime security**: Define, recognize, and apply this concept in realistic engineering work.
